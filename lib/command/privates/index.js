...
/* #region Fail Cases */
// TODO: make the fail cases part as a mixin, maybe.
// TODO: make the success cases as another mixin too.
...
exports.handleCompleteInvalidArgument = function() {
    info('privates.handleCompleteInvalidArgument()');

    display.printCompleteInvalidArgument();
...
exports.handleAppendInvalidArgument = function() {
    info('privates.handleAppendInvalidArgument()');

    display.printAppendInvalidArgument();
...
exports.handlePrependInvalidArgument = function() {
    info('privates.handlePrependInvalidArgument()');

    display.printPrependInvalidArgument();
...
exports.handleReplaceInvalidArgument = function() {
    info('privates.handleReplaceInvalidArgument()');

    display.printReplaceInvalidArgument();
