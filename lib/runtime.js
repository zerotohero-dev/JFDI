...
console.log(process.argv);
    ...
    // TODO: put these options in a config file, so that people can change
    ...
    .option(
        '-m --append <text>',
        'Appends a piece of text to the given goal.',
        parseInt
    );
    ...
    .option(
        '-w, --with <text>',
        '(only for replacements) the text to replace with.'
    );
    ...
    .action(function() {
        console.log('handle today hooray!');
    ...
    .action(function() {
        console.log('handle tomorrow hooray!');
