...
exports.printTabulaRasaForFuture = function() {
    println('');
    println('       Your foreseeable future is pretty blank. Why not add some goals to it?');
    println('');
    println('       Sample Usage:');
    println('           Add a Goal       : jfdi -a "Save the world; one goal at a time."');
    println('           List Goals       : jfdi -l');
...
exports.printGoalAdded = function(goal) {
    println('   ✓ – Added (' + goal + ').\n');
};

exports.printGoalDeferred = function(later, text) {
    println('   ✓ – Deferred #' + later + ' (' + text + ').\n');
};

exports.printGoalExpedited = function(sooner, text) {
    println('   ✓ – Expedited #' + sooner + ' (' + text + ').\n');
};

exports.printGoalPrioritized = function(upper, text) {
    println('   ✓ – Prioritized #' + upper + ' (' + text + ').\n');
};

exports.printGoalCompleted = function(complete, text) {
    println('   ✓ – Completed #' + complete + ' (' + text + ').\n');
};

exports.printGoalAppended = function(append, text) {
    println('   ✓ – Appended #' + append + ' (' + text + ').\n');
};

exports.printGoalPrepended = function(prepend, text) {
    println('   ✓ – Prepended #' + prepend + ' (' + text + ').\n');
};

exports.printGoalReplaced = function(replace, text, replaceWith) {
    println('   ✓ – Replaced #' + replace + '. Replaced (' +
        text + ') with (' + replaceWith + ').\n');
};

exports.printAppendInvalidArgument = function() {
    // TODO: implement me.
};

exports.printPrependInvalidArgument = function() {
    // TODO: implement me.
}

exports.printCompleteInvalidArgument = function() {
    // TODO: implement moe.
};

exports.printReplaceInvalidArgument = function() {
    // TODO: implement me.
};
