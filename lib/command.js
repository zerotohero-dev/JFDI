...
var privates = {
    ...
    handleAppendIncorrectRealm: function() {
        println('\n*** You cannot append to a future goal. ' +
            'To append to a future goal, ' +
            'move it to today\'s queue, then append to it. ' +
            'Type `jfdi -h` for more info. ***\n'
        );
    ...
    handlePrependIncorrectRealm: function() {
        println('\n*** You cannot prepend to a future goal. ' +
            'To prepend to a future goal, ' +
            'move it to today\'s queue, then prepend to it. ' +
            'Type `jfdi -h` for more info. ***\n'
        );
    ...
    handleReplaceIncorrectRealm: function() {
        println('\n*** You cannot do replacements in a future goal. ' +
            'To replace parts of a future goal, ' +
            'move it to today\'s queue, then do your replacements. ' +
            'Type `jfdi -h` for more info. ***\n'
        );
