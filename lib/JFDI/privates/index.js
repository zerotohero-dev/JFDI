...
var fs = require('fs'),
    ...
    dataRoot = fs.readFileSync(path.join(__dirname, kUpToRoot, kRoot)).toString().trim(),
...
exports.listThunk[kToday] = function(callback) {
    return callback(
        null, {realm: kToday, goals: limit(exports.getTodayGoals())}
    );
};

exports.listThunk[kTomorrow] = function(callback) {
    return callback(
        null, {realm: kTomorrow, goals: limit(exports.getTomorrowGoals())}
    );
};
...
exports.findThunk[kToday] = function(callback, query) {
    return callback(null, {
        query: query,
        realm: kToday,
        goals: limit(exports.getTodayGoals(query))
    });
};
...
exports.findThunk[kTomorrow] = function(callback, query) {
    return callback(null, {
        query: query,
        realm: kTomorrow,
        goals: limit(exports.getTomorrowGoals(query))
    });
};
